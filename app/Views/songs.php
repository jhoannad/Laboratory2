        ...
        <div class="modal-body">
          ...
          <?php if(isset($plist)): ?>
              <?php foreach($plist as $p): ?>
                  <a href="/selplaylist/<?= $p['playlistname']; ?>" class="btn btn-primary" style="text-decoration: none;"><?= $p['playlistname']; ?></a>
                  <a href="/delplaylist/<?= $p['id']; ?>" class="hover-effect">
...
<audio id="audio" controls autoplay></audio>
  ...
  <?php if ($song): ?>
      <?php foreach ($song as $songs):?>
          <li data-src="<?=base_url(); ?>/songs/<?= $songs['musicname']; ?>.mp3"><?= $songs['musicname']; ?>
           <a href="/addmusictoplaylist" class ="hover-effect">
  ...
  <?php else:?>
     <?php foreach ($songs as $s):?>
          <li data-src="<?=base_url(); ?>/songs/<?= $s['musicname']; ?>.mp3"><?= $s['musicname']; ?>
           <a href="/addmusictoplaylist" class ="hover-effect">
            <img src="<?=base_url(); ?>/add.png">
      </a>
    </li>
